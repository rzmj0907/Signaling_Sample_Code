...
- (NSString *)removeSpace {
    ...
    NSString *ret = [self stringByTrimmingCharactersInSet:characterSet];
    return ret;
}
...
+ (NSString *)randomChannelName {
    ...
    NSString *ret = [NSString stringWithFormat:@"%x_%x_Room", x, y];
    return ret;
}

+ (NSString *)randomCallRequestId {
    uint32_t x = arc4random();
    uint32_t y = arc4random();
    NSString *ret = [NSString stringWithFormat:@"%x_%x_Request", x, y];
    return ret;
}
